...
using Diploma.ViewModels.ProductsVM;
...
namespace Diploma.Pages
{
    public partial class ProductsPage : Page
    {
        ...
        void LoadData()
        {
            ...
            {
                DataTable.ItemsSource = context.Products.ToList();
            }
        ...
        {
            var selItem = DataTable.SelectedItem as Products;

            if (selItem == null)
                return;

            ProductEditWindow window = new(selItem.Id);
            window.ShowDialog();
            LoadData();
        }
        ...
        void DeleteInformation()
        {
            ...
            if (res == MessageBoxResult.Yes)
            {
                try
                {
                    using (var context = new AppDbContext())
                    {
                        context.Products.Remove(selItem);
                        context.SaveChanges();
                    }
                    LoadData();
                }
